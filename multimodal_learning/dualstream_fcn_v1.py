...
class DualStreamFCN(SaveableModule):
    ...
    def __init__(self, num_classes, num_residual_units=3, filters=(16, 64, 128, 256, 512),
        ...
        self.rank = None
        super(DualStreamFCN, self).__init__(name)
    ...
    def _build(self, inp, streamid, is_training=True):
        ...
        # Check whether to use encoder0 or encoder1
        ...
        # with tf.variable_scope('stream0'):
        #     x0 = inp
        #     x0 = Convolution(filters[0], strides=strides[0])(x)
        #     print(x0.get_shape())
        #     # residual feature encoding blocks with num_residual_units at different scales defined via strides
        ...
        # with tf.variable_scope('stream1'):
        #     x1 = inp
        #     x1 = Convolution(filters[0], strides=strides[0])(x1)
        #     print(x1.get_shape())

        # scales = tf.cond(tf.equal(streamid, tf.constant(0)), lambda: [x0], lambda: [x1])
