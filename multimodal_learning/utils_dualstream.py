...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 13:49:29 2017
...
def sliding_window_segmentation_inference(session, ops_list, sample_dict, streamid, batch_size=1):
    """
    ...
    while True:
        ...
        if batch_size == 1:
            ...
            sw_dict[streamid.keys()[0]] = streamid.values()[0]
            ...
            if len(slicers) == batch_size or done:
                ...
                all_op_parts = session.run(ops_list, feed_dict= {{slices_dict}, streamid})
